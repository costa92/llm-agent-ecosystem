...
| `llm-agent-rag` | standalone RAG SDK — import, retrieval, generation, GraphRAG | **v1.5.0** | `master` | <https://github.com/costa92/llm-agent-rag> |
...
to `llm-agent-rag v1.5.0` (which folds in v1.0.6 trace+parser fixes,
...
and the v1.5.0 cost/retry surface
